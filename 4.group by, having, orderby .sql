...
SELECT EMP_NO ,EMP_NM ,BIRTH_DE ,DEPT_CD  FROM tb_emp
ORDER BY dept_cd
;
...
HAVING AVG(pay_amt) >= 4500000
ORDER BY emp_no
-- select from where group by havaing order by 순!
;